          ...
          <ul class="menu-list flex-grow-1 mt-3">
              ...
              <li  class="collapsed">
                  <a class="m-link"  data-bs-toggle="collapse" data-bs-target="#project-Components" href="#">
                      <i class="icofont-briefcase"></i><span>Gestion de l'annuaire</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                  <!-- Menu: Sub menu ul -->
                  <ul class="sub-menu collapse" id="project-Components">
                      <li><a class="ms-link" href="projects.html"><span>Liste</span></a></li>
                      <li><a class="ms-link" href="{{ route('entreprise.create') }}"><span>Ajouter une entreprise</span></a></li>
              ...
              <li class="collapsed">
                  <a class="m-link" data-bs-toggle="collapse" data-bs-target="#tikit-Components" href="#"><i
                          class="icofont-ticket"></i> <span>Gestion des publications</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                  <!-- Menu: Sub menu ul -->
                  <ul class="sub-menu collapse" id="tikit-Components">
                      <li><a class="ms-link" href="tickets.html"> <span>Liste de publications</span></a></li>
                      <li><a class="ms-link" href="ticket-detail.html"> <span>Ajouter une publication</span></a></li>
                  </ul>
              </li>
              <li class="collapsed">
                  <a class="m-link" data-bs-toggle="collapse" data-bs-target="#client-Components" href="#"><i
                          class="icofont-user-male"></i> <span>Gestion des entreprises</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                  <!-- Menu: Sub menu ul -->
                  <ul class="sub-menu collapse" id="client-Components">
                      <li><a class="ms-link" href="ourclients.html"> <span>Liste des entreprises</span></a></li>
                      <li><a class="ms-link" href="profile.html"> <span>Ajouter une entrepries</span></a></li>
                  </ul>
              </li>
              <li class="collapsed">
                  <a class="m-link" data-bs-toggle="collapse" data-bs-target="#emp-Components" href="#"><i
                          class="icofont-users-alt-5"></i> <span>Gestion des annonces</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                  <!-- Menu: Sub menu ul -->
                  <ul class="sub-menu collapse" id="emp-Components">
                      <li><a class="ms-link" href="members.html"> <span>Liste des annonces</span></a></li>
                      <li><a class="ms-link" href="employee-profile.html"> <span>Ajouter une annonce</span></a></li>
              ...
              <li class="collapsed">
                  <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Componentsone" href="#"><i
                          class="icofont-ui-calculator"></i> <span>Gestion des Commentaires</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                  <!-- Menu: Sub menu ul -->
                  <ul class="sub-menu collapse" id="menu-Componentsone">
                      <li><a class="ms-link" href="invoices.html"><span>Liste des commentaires</span> </a></li>
                      <li><a class="ms-link" href="payments.html"><span>Ajouter un commentaire</span> </a></li>
              ...
              <li class="collapsed">
                  <a class="m-link" data-bs-toggle="collapse" data-bs-target="#payroll-Components" href="#"><i
                          class="icofont-users-alt-5"></i> <span>Gestion des Réponses</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                  <!-- Menu: Sub menu ul -->
                  <ul class="sub-menu collapse" id="payroll-Components">
                      <li><a class="ms-link" href="salaryslip.html"><span>Liste des réponses</span> </a></li>
                      
                  </ul>
                  <ul class="sub-menu collapse" id="payroll-Components">
                    <li><a class="ms-link" href="salaryslip.html"><span>Ajouter une réponse</span> </a></li>
